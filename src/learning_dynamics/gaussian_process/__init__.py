import torch
from .kernels import kernel_ode

def gaussian_process(train_time_points, prior_mean, prior_var, test_time_points, length_scale=1, nat_freq=None, damp_ratio=None):
